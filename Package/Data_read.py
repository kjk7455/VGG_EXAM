...
class DataRead:
    def __init__(self, batch_size):
        ...
        self.train_list = glob('../Train/*/*.png')
        self.test_list = glob('../Test/*/*.png')
    ...
    def _random_function(self, image_decoded, label):
        ...
        self.image = tf.image.resize_images(image_decoded, [300, 300])
        self.image = tf.image.random_crop(self.image, [200, 200, 1])
